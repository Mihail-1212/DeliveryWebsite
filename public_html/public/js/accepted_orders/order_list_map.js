window.addEventListener("load", async function(){
    ...
    var button_show_execute = document.getElementById('orderExecuted');
    ...
    var modal_window_show_executed = document.getElementById('modal_window_execute_order');
    ...
    var executed_order = new Modal_Window(button_show_execute, modal_window_show_executed);
    ...
    for(let i = 0; i < order_items.length; i++){
        ...
        order_item.addEventListener('click', async function(e){
            ...
            var orderId = closestOrderItem.dataset.order;  
    		let parameters = {
              order: orderId,
            };
    ...
    async function FetchGetOrder(parameters){
        ...
        if (response.ok) {
            ...
            button_show_execute.style.visibility = "visible";
